      ...
      child: InkWell(
        ...
        child: StreamBuilder(stream: APIs.getLastMessage(widget.user), builder: (context, snapshot){
          ...
          return ListTile(
            ...
            subtitle: Text(_message != null ? _message!.msg :  widget.user.about,maxLines: 1,style: TextStyle(fontSize: 13,color: Colors.black54),),
            ...
            ): Text(MyDateUtil.getLastMessageTime(context: context, time: _message!.sent),style: const TextStyle(fontSize: 13,color: Colors.black54),),
          );
        })
      ),
    );
